...
/**
 * Threads — reactbits.dev animated background (WebGL/OGL). A field of flowing
 * Perlin-noise lines that drift on their own and bend toward the cursor when
 * `enableMouseInteraction` is on. Used tinted + subtle behind the hero for a
 * modern, interactive feel (not a static page). Renders with alpha so it sits
 * over the near-black surface.
 */
const vertexShader = `
