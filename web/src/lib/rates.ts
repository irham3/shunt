...
// Note: the Grow lane values gold from LIVE DEX pathfinding (see lib/growth.ts),
// not a hardcoded reference rate — the former getGoldUsdRate()/FALLBACK_XAUM_USD
// helper was removed with the reference-rate simulation ("real over mock").
